...
<body>
    ...
    <div class="container" style="padding-top:10px;">
        ...
        <form method="post" name="createUser" action="<?php echo base_url() . 'index.php/companycontroller/createCompany'; ?>">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>GST.NO </label>
                        <input type="text" name="gst" class="form-control" value="<?php echo set_value('gst'); ?>">
