                    ...
                    <div class="col-md-12">
                        <h1>
                            ...
                            <div class="float-right mr-4 mt-3">
								...
								<a style="background: #ec9a29; color:white;" href="javascript:void(0);" class="btn" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Table</a>
<a style="background: #ec9a29;" href="javascript:void(0);"  class="btn btn-success"  data-toggle="modal" data-target="#Modal_Add_Takeaway"><span class="fa fa-plus"></span> Takeaway</a>

							</div>

						</h1>
						<h3 style="padding-top: 25px;">Dine In</h3>
                    </div>
                </div>
                <div class="modal fade" id="myModal">
                </div>
                <div class="row" id="show_data" style="margin-top:50px; border-bottom: solid black 2px; margin-left:0px">
				...
				<div class="row" id="show_data" style="margin-left: 10px">
					<h3 style="padding-left: 20px"> Takeaways</h3>
	...
	<!-- MODAL ADD -->
	<form>
		<div class="modal fade" id="Modal_Add_Takeaway" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title text-center" id="exampleModalLabel">Add New Takeaway Slot</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<div class="form-group row">
							<label class="col-md-2 col-form-label">Takeaway Name</label>
							<div class="col-md-10">
								<input type="text" name="name" id="name" class="form-control" placeholder="Takeaway Name">
							</div>
						</div>
					</div>
					<div class="modal-footer">
 ...
 $('#inputState').change(function() {
      ...
      $('#takeaway').click(function() {
                window.location = "http://localhost/index.php/HomeScreenController/order";
            });
