...
class EmployeeController extends CI_Controller
{
	...
	public function insert()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->Employee_model->insert_entry($ajax_data)) {
	...
	{
		if ($this->input->is_ajax_request()) {
			$posts = $this->Employee_model->get_entries();
	...
	public function delete()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->Employee_model->delete_entry($del_id)) {
	...
	public function edit()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($post = $this->Employee_model->edit_entry($edit_id)) {
	...
	public function update()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->Employee_model->update_entry($data)) {
