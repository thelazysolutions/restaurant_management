...
class SupplierController extends CI_Controller
{
	...
	public function insert()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->supplierModel->insert_entry($ajax_data)) {
	...
	{
		if ($this->input->is_ajax_request()) {
			$posts = $this->supplierModel->get_entries();
	...
	public function delete()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->supplierModel->delete_entry($del_id)) {
	...
	public function edit()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($post = $this->supplierModel->edit_entry($edit_id)) {
	...
	public function update()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->supplierModel->update_entry($data)) {
