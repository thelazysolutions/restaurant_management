...
class CompanyController extends CI_Controller
{
	...
	public function insert()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->Company_model->insert_entry($ajax_data)) {
	...
	{
		if ($this->input->is_ajax_request()) {
			$posts = $this->Company_model->get_entries();
	...
	public function delete()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->Company_model->delete_entry($del_id)) {
	...
	public function edit()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($post = $this->Company_model->edit_entry($edit_id)) {
	...
	public function update()
	{
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->Company_model->update_entry($data)) {
